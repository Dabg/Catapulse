package Catapulse::Formatter::SyntaxHighlight;
...
my $main_formatter;
eval { $main_formatter = Catapulse->pref('main_formatter'); };
$main_formatter ||= 'Catapulse::Formatter::Markdown';

=head1 NAME

Catapulse::Formatter::SyntaxHighlight - syntax highlighting for code blocks
...
L<Catapulse>, L<Module::Pluggable::Ordered> and L<Syntax::Highlight::Engine::Kate>.
