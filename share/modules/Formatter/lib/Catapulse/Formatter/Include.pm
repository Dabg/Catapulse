package Catapulse::Formatter::Include;
...
Catapulse::Formatter::Include - Include files in your content.
...
L<inline|Catapulse::Controller::Page/inline> version of the page is pulled.
...
formatters (except L<Redirect|Catapulse::Formatter::Redirect>), so that
...
L<Catapulse>, L<Module::Pluggable::Ordered>, L<URI::Fetch>
