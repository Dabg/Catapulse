package Catapulse::Formatter::RSS;
...
Catapulse::Formatter::RSS - Include RSS feeds on your page.
...
L<Include|Catapulse::Formatter::Include>), so that transcluding
...
L<Catapulse>, L<Module::Pluggable::Ordered>, L<XML::Feed>, L<URI::Fetch>
