package Catapulse::Formatter::Defang;

use strict;
use warnings;
use parent qw/Catapulse::Formatter/;
use Catapulse::Declaw;
use URI;

=head1 NAME

Catapulse::Formatter::Defang - Scrub user HTML and XSS

=head1 DESCRIPTION

This formatter makes sure only a safe range of tags are
allowed, using L<Catapulse::Defang>; It also tries to remove XSS attempts.
...
sub format_content {
    ...
    my $defang = Catapulse::Declaw->new(
        context             => $c,
...
L<Catapulse>, L<Module::Pluggable::Ordered>, L<Catapulse::Defang>
