package Catapulse::Formatter::Textile;
...
Catapulse::Formatter::Textile - Texile+SmartyPants formatting for your content
...
sub main_format_content {
    ...
    # See justification in L<Catapulse::Formatter::Markdown/format_content>.
    $$content =~ s/\n*$/\n/;
    return $$content;
}
