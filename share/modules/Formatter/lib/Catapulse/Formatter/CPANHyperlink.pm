package Catapulse::Formatter::CPANHyperlink;

use parent qw/Catapulse::Formatter/;

=head1 NAME

Catapulse::Formatter::CPANHyperlink - automatically hyperlink CPAN modules when
...
Normally, to hyperlink to a CPAN module, you'd write:
    ...
    [Catapulse::Formatter::CPANHyperlink](http://search.cpan.org/perldoc?Catapulse::Formatter::CPANHyperlink)

This plugin lets you write just

    {{cpan Catapulse::Formatter::CPANHyperlink}}
...
L<Catapulse> and L<Module::Pluggable::Ordered>.
