package Catapulse::Formatter::DocBook;
...
my $eval_res = $@;
use Catapulse::Formatter::DocBook::Colorize;
...
Catapulse::Formatter::DocBook - format part of content as DocBook
...
sub to_xhtml
{
    ...
    my $my_Handler = Catapulse::Formatter::DocBook::Colorize->new($debug);
