package Catapulse::Formatter::Markdown;
...
Catapulse::Formatter::Markdown - MultiMarkdown formatting for your content.
...
L<Catapulse::Schema::ResultSet::Content::format_content>.

C<main_format_content> will only be called by <Catapulse::Formatter::Main>.
...
L<Catapulse>, L<Module::Pluggable::Ordered>, L<Text::MultiMarkdown>
