use utf8;
package Catapulse::Schema::Result::Content;
...
Catapulse::Schema::Result::Content - Versioned page content
...
#     },
# );
__PACKAGE__->belongs_to( "creator", "Catapulse::Schema::Result::User", { id => "creator" } );
...
References L<Catapulse::Schema::Result::Page>.

=head2 creator

References L<Catapulse::Schema::Result::User>.
...
Return the content after being run through Catapulse::Formatter::*.
...
sub store_links {
    ...
    require Catapulse::Formatter::Wiki;
    my ( $linked_pages, $wanted_pages ) = Catapulse::Formatter::Wiki->find_links( \$content, $page );
