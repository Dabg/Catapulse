package Catapulse::Schema::ResultSet::Content;
...
Catapulse::Schema::ResultSet::Content - resultset methods on content
...
sub create_proto {
    ...
    eval {
        $page->isa('Catapulse::Schema::Page');
        $page->content->isa('Catapulse::Schema::Content');
    };
    if ($@) {
