...
catapulse_spawn_db.pl - hash plain text passwords
...
my $jfdi   = Config::JFDI->new(name => "Catapulse::Web");
my $config = $jfdi->get;
...
catapulse_spawn_db.pl ...

This script looks in the catapulse.conf file for database connection
info if none is passed on the command line. Set the CATAPULSE_CONFIG
environment variable to tell it where the file is.

Accepts the following options:

  --dsn              Default taken from catapulse.conf
  --db-user          Default taken from catapulse.conf
  --db-password      Default taken from catapulse.conf
  --wiki             Wiki name, default taken from catapulse.conf
